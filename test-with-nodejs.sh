...
ecow "Create a new remote git repository named dokku that points to dokku@mainga.me:nodetest"
echo "git remote dokku dokku@mainga.me:nodetest"
git remote add dokku dokku@mainga.me:nodetest
ecow "Push the local master branch to dokku"
echo "git push dokku master"
git push dokku master
ecow "Test the remote deployment at nodetest.mainga.me"
echo "curl nodetest.mainga.me"
curl nodetest.mainga.me
