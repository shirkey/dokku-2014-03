...
curl "https://api.digitalocean.com/domains/new?client_id=$DIGITAL_OCEAN_CLIENT_ID&api_key=$DIGITAL_OCEAN_API_KEY&name=$dokku_domain_name&ip_address=$dokku_server_ip"
